...
:function_id: request_url
include::_snippets/function.adoc[]

:function_id: request_options
include::_snippets/function.adoc[]
...
The `HttpResponseBode` allows you to easily parse HTTP response bodies into a useable form.

=== HttpResonseBody.contentType
